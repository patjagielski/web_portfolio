...
function LoginPage({finishLogin, getLiterals, setStoreLang, getLang}){
    ...
    return( 
        ...
        <div className="d-flex justify-content-center">
            <h1 className="display-1 text-info">{getLang === "en" ? (getLiterals.en.app_login):( lang === "pl" ? (getLiterals.pl.app_login):(getLiterals.ru.app_login))}</h1>
        </div>
        ...
        <h2 className="h1 text-muted">{getLang === "en" ? (getLiterals.en.login):( lang === "pl" ? (getLiterals.pl.login):(getLiterals.ru.login))}</h2>
            ...
            />
            <button className="button-layout" onClick={handleLogin}>Submit</button>
        </div>


        <div className="box-layout__box">
        <h2 className="h1 text-muted">{getLang === "en" ? (getLiterals.en.register):( lang === "pl" ? (getLiterals.pl.register):(getLiterals.ru.register))}</h2>
            <input className="text-input" type="text" placeholder="username" 
                onChange={(e)=>{
                    setUsername(e.target.value);
            }}
            ...
            />
            <input className="text-input" types="text" placeholder="email"
                onChange={(e)=>{
            ...
            <input className="button-layout" type="button" value="Register" onClick={(handleRegister)}/>
        </div>
        </div>
